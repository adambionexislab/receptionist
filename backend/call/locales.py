...
SK_DEMO_EMAIL_STEPS = (
    ...
    "1. Spýtajte sa presne touto vetou: 'Povedzte mi prosím vašu e-mailovú\n"
    "   adresu, pričom časť pred zavináčom mi vyhláskujte.' Nič k nej\n"
    "   nepridávajte, nepýtajte sa na časti adresy zvlášť a neuvádzajte\n"
    "   žiadne príklady. Počkajte, kým volajúci celú adresu dopovie.\n"
