...
SK_DEMO_EMAIL_STEPS = (
    ...
    "1. Poproste volajúceho, nech vám celú e-mailovú adresu nahláskuje po\n"
    "   písmenách. Nepýtajte sa na jej časti zvlášť a neuvádzajte žiadne\n"
    "   príklady. Počkajte, kým adresu dopovie.\n"
