...
SK_DEMO_EMAIL_STEPS = (
    ...
    "   normálne.\n"
    "4. Ďalšou otázkou pokračujte IBA vtedy, keď volajúci výslovne potvrdí,\n"
    "   že adresa je správna ('áno', 'správne', 'presne tak').\n"
    "5. Ak volajúci povie 'nie', že je niečo zle, alebo adresu opraví, adresa\n"
    ...
    "6. Nikdy si žiadne písmeno nedomýšľajte: ak ste niečomu nerozumeli,\n"
    "   poproste volajúceho, nech zopakuje iba to miesto.\n"
    "7. Iba ak volajúci hneď na otázku o e-mail povie, že e-mail nemá alebo ho\n"
