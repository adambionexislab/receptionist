...
_DEMO_EMAIL_SECTION = (
    ...
    "4. Passa alla domanda successiva SOLO quando il chiamante conferma\n"
    "   esplicitamente che l'indirizzo è corretto ('sì', 'esatto', 'giusto').\n"
    "5. Se il chiamante dice 'no', che qualcosa è sbagliato, o corregge\n"
    ...
    "6. Non indovinare mai una lettera: se qualcosa non ti è chiaro, chiedi al\n"
    "   chiamante di ripetere solo quel punto.\n"
    "7. Solo se, alla domanda sull'email, il chiamante dice subito che non ce\n"
