...
_DEMO_EMAIL_SECTION = (
    ...
    "1. Chiedi esattamente con questa frase: 'Mi dica il suo indirizzo email,\n"
    "   compitando la parte prima della chiocciola.' Non aggiungere altro,\n"
    "   non chiedere le parti separatamente e non citare alcun esempio.\n"
    "   Aspetta che il chiamante abbia detto l'intero indirizzo.\n"
    ...
    "3. Passa alla domanda successiva SOLO quando il chiamante conferma\n"
    "   esplicitamente che l'indirizzo è corretto ('sì', 'esatto', 'giusto').\n"
    "4. Se il chiamante dice 'no', che qualcosa è sbagliato, o corregge\n"
    "   l'indirizzo, l'indirizzo NON è confermato e NON devi passare alla\n"
    "   domanda successiva. Chiedi cosa è sbagliato (se non l'ha già detto),\n"
    "   richiedi solo quella parte, poi ripeti l'intero indirizzo corretto e\n"
    "   chiedi di nuovo se è giusto. Ripeti finché il chiamante non conferma.\n"
    "5. Non indovinare mai una lettera: se qualcosa non ti è chiaro, chiedi al\n"
    "   chiamante di ripetere solo quel punto.\n"
    "6. Solo se, alla domanda sull'email, il chiamante dice subito che non ce\n"
    "   l'ha o che non vuole darla, non insistere e prosegui. Un 'no' dopo\n"
    "   che hai ripetuto l'indirizzo NON è mai un rifiuto: vuol dire che\n"
